(function (window) {
    ...
    class Captcha {
        constructor(el, success, fail, onchange, onreset) {
            this.el = el;
        ...
        verify() {
            ...
            console.log("结果比较", Math.abs(left - this.x));
            return {
    ...
    window.Captcha = {
        init: function (element, success, fail, onchange, reset) {
            new Captcha(element, success, fail, onchange, reset).init();
        }
    }
}(window));